...
public class CreatureTest {
    ...
    void defenderShouldLost2HpBecauseOfArmor(){
        //given
        Creature student = new ElementalCreature(1,1, 1, "Student",1,512);
        Creature professor = new ElementalCreature(1000,500, 500, "Professor",11,1);
        //when
    ...
    void defenderShouldLost0HpBecauseArmorIsGraterThanAttackerDamage(){
        //given
        Creature student = new ElementalCreature(1,1, 1, "Student",1,1);
        Creature professor = new ElementalCreature(1000,500, 500, "Professor",11,1);
        //when
